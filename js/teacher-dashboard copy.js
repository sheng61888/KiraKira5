...
class TeacherDashboard {
    ...
    getCurrentTeacherId() {
        // This must match the ID in your teacher_classes table
    ...
    async loadCourses() {
        try {
            ...
            courses.forEach(course => {
                const option = document.createElement('option');
                option.value = course.courseName; // This matches the C# DTO
    ...
    // (All other functions from your js/teacher-dashboard.js file are correct)
    // ... [Paste the rest of your js/teacher-dashboard.js file here] ...
        ...
        const assignmentsHtml = assignments.map(assignment => `
            <div class="assignment-card ${this.getAssignmentCardClass(assignment)}">
                ...
                <div class="assignment-actions">
                    <button class="btn btn--ghost btn-sm" onclick="editAssignment(${assignment.assignmentId})">Edit</button>
                    <button class="btn btn--ghost btn-sm" onclick="updateAssignmentStatus(${assignment.assignmentId}, 'Completed')">Mark Complete</button>
